...
def MountSupp():
    ...
    if (SorD == "Single-access"): #Determining if it's a single or double access structure
        ...
        if (TableTilt == "Standard Tilt"):
            ...
            if(TotalRafterL == 6200 and angle == np.deg2rad(10) and GroundClearance == 2500 and FROHang == 1200 and RROHang == 350):
                RearSupport = 1075
            ...
            elif(TotalRafterL == 6500 and angle == np.deg2rad(10) and GroundClearance == 2500 and FROHang == 1200 and RROHang == 450):
                RearSupport = 1075
                RearSupportCode = "LM-CP-SB-MILL-"+str(RearSupport)
                CentreSupport = 1180
                CentreSupportCode = "LM-CP-SB-MILL-"+str(CentreSupport)
            ...
            elif(TotalRafterL == 6500 and angle == np.deg2rad(10) and GroundClearance == 2500 and FROHang == 1200 and RROHang == 350):
                RearSupport = 1780
                RearSupportCode = "LM-CP-SB-MILL-"+str(RearSupport)
                CentreSupport = 1450
                CentreSupportCode = "LM-CP-SB-MILL-"+str(CentreSupport)
        ...
        if(TotalRafterL == 10800 and angle == np.deg2rad(8) and GroundClearance == 2500 and FROHang == 1200 and RROHang == 1200):
            RearSupport = 3400
            RearSupportCode = "LM-CP-SB-MILL-"+str(RearSupport)
            CentreSupport1 = 1300
        ...
        elif(TotalRafterL == 11200 and angle == np.deg2rad(8) and GroundClearance == 2500 and FROHang == 1200 and RROHang == 1200):
            RearSupport = 3497
            RearSupportCode = "LM-CP-SB-MILL-"+str(RearSupport)
            CentreSupport1 = 1265
            CentreSupportCode1 = "LM-CP-SB-MILL-"+str(CentreSupport1)
        ...
        if(TotalRafterL == 6500 and angle == np.deg2rad(6) and GroundClearance == 2500 and FROHang == 1200):
            RearSupport = 4420
            RearSupportCode = "LM-CP-SB-MILL-"+str(RearSupport)
            CentreSupport1 = 1410
            CentreSupportCode1 = "LM-CP-SB-MILL-"+str(CentreSupport1)
...
def getStdSupportBarLength(Description):
    ...
    if("Carport Support Bar" in Description):
        SBLengthArray = [1075, 1100, 1180, 1265, 1300, 1360, 1370, 1410, 1450, 1500, 1620, 1690, 1710, 1740, 1780, 2130, 2250, 2280, 2300, 2320, 2440, 2480, 2510, 2530, 2580, 2700, 2750, 2930, 2980, 3390, 3400, 3425, 3440, 3497, 3580, 3610, 3670, 3680, 3715, 3730, 3820, 3905, 3940, 3945, 3990, 4000, 4020, 4050, 4180, 4270, 4320, 4360, 4420, 4580, 4760, 6000]
    else:
